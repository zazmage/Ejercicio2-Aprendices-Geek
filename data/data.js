export const data = [
  ...
  {
    id: 4,
    name: "ACOND.TIO-NACHO-ENGROSADOR-415-ML",
    image: "images/ACOND.TIO-NACHO-ENGROSADOR-415-ML_650240035159.jpg",
    price: 10000,
    description: `Características principales:
    La nueva línea Engrosador con jalea real y ortiga, una combinación de ingredientes de origen natural, aumentan el diámetro de cada pelo dejándolo más fuerte, más grueso y con mayor volumen gracias a su fórmula con el componente exclusivo Capilgross. Usa el Sistema completo de Tío Nacho Engrosador: tratamiento, shampoo y acondicionador.`,
  },
  {
    id: 5,
    ...
    INGREDIENTES NATURALES: Jalea Real y aceite de coco orgánico.
    HIDRATACIÓN PROFUNDA: Su fórmula penetra y retiene la hidratación, devolviendo el 100% del agua perdida desde el primer uso.
    USO DIARIO: Luego de aplicar el Shampoo Tío Nacho Engrosador, aplicar el Acondicionador de medios a puntas sobre el cabello mojado y enjuaga con abundante agua.
    ESCUDO PROTECTOR: Tío Nacho Acondicionador Ultra Hidratante posee ingredientes y extractos de origen natural que ayudan a prevenir el daño futuro, formando un escudo protector que recubre la cutícula, dejando el cabello hidratado, brillante y suave hasta las puntas.`,
  },
  {
    id: 6,
